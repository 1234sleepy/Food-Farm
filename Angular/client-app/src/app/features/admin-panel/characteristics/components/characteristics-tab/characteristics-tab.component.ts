...
export class CharacteristicsTabComponent {
  id: string = '';
  constructor(private productService: ProductStoreService, private adminProductService: AdminProductStoreService, private route: ActivatedRoute, private router: Router) {
